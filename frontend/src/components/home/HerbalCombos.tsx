...
interface ProductItem {
  ...
  image: string;
  quantity: number;
  tags?: string[]; // ✅ assume products have tags array
}

interface HerbalCombosProps {
  products?: ProductItem[];
}

export default function HerbalCombos({
    ...
    if (!initialProducts) {
      async function fetchHerbalCombos() {
        try {
          ...
          // ✅ Use _id as the product identifier
          ...
          console.error("Error fetching herbal combos:", err);
          setProducts([]);
        } finally {
          setLoading(false);
        }
